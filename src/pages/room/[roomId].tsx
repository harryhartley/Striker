...
import { useEventSubscriptions } from '~/hooks/eventSubscriptions'
...
const StrikerRoomCore = () => {
  ...
  useEventSubscriptions(
    ...
    roomConfig,
    setStateRoomStatus,
    setStateP1CharacterLocked,
    setStateP2CharacterLocked,
    setStateRoomState,
    setStateP1Character,
    setStateP2Character,
    setStateCurrentBans,
    setStateSelectedStage,
    setStateCurrentScore,
    setStateMostRecentWinner,
    setStateFirstBan,
    setStateRevertRequested
  )
  ...
  if (!session) {
    return <div>Not authorised. Please sign in to view this page.</div>
  }
      ...
      return (
        <div className="flex justify-center">
          <button
            ...
            className="rounded bg-green-500 px-4 py-2 text-4xl text-white hover:bg-green-700"
          >
    ...
    return (
      <>
        <div className="mb-4 flex items-end justify-center space-y-2 pt-4 md:space-y-5">
          ...
          <div className="md:leading-14 flex w-auto flex-1 justify-center break-all text-2xl font-extrabold leading-9 tracking-tight sm:text-3xl sm:leading-10 md:text-5xl">
            {iAmPlayer === 1 && (
              <button disabled={iAmPlayer !== 1} onClick={handleRemoveP2Id}>
                ❌
              </button>
            )}
            {room.p2?.name}
